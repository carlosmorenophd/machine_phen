...
from src.machines.enums import RandomForestJson, MachinesNameJson
...
def machine_single_file_single(files_in: str, target_column: str, machine_str: str) -> None:
    ...
    if machine_json["name"] == MachinesNameJson.RF.value:
        machine_build = RandomForestJson(name=MachinesNameJson.RF)
